...
MD_MAX72XX::fontType_t ExtASCII[] PROGMEM =
{
  ...
  0,		// 4 - 'Unused'
  0,		// 5 - 'Unused'
  8, 0, 0, 0, 0, 00, 0, 0, 255,    // 6 - Strich
  8, 120, 205, 138, 136, 205, 122, 40, 56,		// 7 - Tasse
  10, 28, 50, 114, 126, 50, 50, 62, 114, 114, 62,    // 8 - Bus
  9, 0, 62, 127, 65, 119, 119, 65, 127, 62,		// 9 - Haltestelle
  0,		// 10 - 'Unused'
  0,		// 11 - 'Unused'
  0,		// 12 - 'Unused'
  0,		// 13 - 'Unused'
  ...
  9, 0, 126, 255, 177, 181, 181, 205, 255, 126,		// 253 - Linie5
  8, 255, 193, 129, 159, 159, 129, 193, 255,		// 229 - UBahn
  8, 126, 255, 211, 181, 173, 203, 255, 126,		// 230 - SBahn
